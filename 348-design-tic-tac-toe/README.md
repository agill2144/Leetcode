<h2><a href="https://leetcode.com/problems/design-tic-tac-toe">Design Tic-Tac-Toe</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Assume the following rules are for the tic-tac-toe game on an <code>n x n</code> board between two players:</p>
