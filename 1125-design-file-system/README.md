<h2><a href="https://leetcode.com/problems/design-file-system">Design File System</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are asked to design a file system&nbsp;that allows you to create new paths and associate them with different values.</p>
