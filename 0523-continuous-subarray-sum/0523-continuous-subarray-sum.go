/*
    ...
    - How do we check previous subarrays that collected to x as running sum ?
    - If the remainder is not 0, it means the remainder is up by some value
        ...
        - by removing the number that caused it to go up by 5
        ...
        - it means, that if we remove all those values from idx 0 until y including y, then we wont have a 
